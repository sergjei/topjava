...
//    public List<MealTo> getBetweenLdt(@PathVariable  LocalDate startDate,
...
//    }
    @GetMapping("/filter/{startDate}/{startTime}/{endDate}/{endTime}")
    public List<MealTo> getBetweenLdt(@PathVariable(required = false) LocalDate startDate,
                                      @PathVariable(required = false) LocalTime startTime,
                                      @PathVariable(required = false) LocalDate endDate,
                                      @PathVariable(required = false) LocalTime endTime) {
        return super.getBetween(startDate, startTime, endDate, endTime);
    }
}