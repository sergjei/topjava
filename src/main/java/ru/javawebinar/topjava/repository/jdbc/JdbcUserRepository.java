...
public class JdbcUserRepository implements UserRepository {
    ...
    public User save(User user) {
        ...
        if (user.isNew()) {
            ...
            jdbcTemplate.batchUpdate(createRolesSql, new RoleBatchPreparedStatementSetter(user));
    ...
    public User get(int id) {
        List<User> users = jdbcTemplate.query("SELECT * FROM users u JOIN user_role ur ON ur.user_id = u.id WHERE u.id=?",
    ...
    public User getByEmail(String email) {
        List<User> users = jdbcTemplate.query("SELECT * FROM users u JOIN user_role ur ON ur.user_id = u.id WHERE email=?",
